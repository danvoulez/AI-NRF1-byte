...
import { fetchExecutions, type Execution, type ExecutionState } from "@/lib/api"
      ...
      {isEmpty ? (
        ...
        <>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <Button variant="outline" size="sm" className="h-10 bg-transparent" onClick={handleExportCSV}>
          ...
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <span>Exibindo {filtered.length} de {executions.length} execucoes</span>
